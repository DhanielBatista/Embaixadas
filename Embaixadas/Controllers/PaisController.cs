...
namespace Embaixadas.Controllers
{
    public class PaisController : Controller
    {
        ...
        public PaisController(EmbaixadasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("PaisId,PaisNome,PaisCapital")] Pais pais)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaisId,PaisNome,PaisCapital,PaisMoeda")] Pais pais)
        {
            if (id != pais.PaisId)
            {
                return NotFound();
